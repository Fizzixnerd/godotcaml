...
module BuiltinClassSize = struct
  module Float_32 = struct
    ...
    let _PackedByteArray = 
    8

    let _PackedInt32Array = 
    8

    let _PackedInt64Array = 
    8

    let _PackedFloat32Array = 
    8

    let _PackedFloat64Array = 
    8

    let _PackedStringArray = 
    8

    let _PackedVector2Array = 
    8

    let _PackedVector3Array = 
    8

    let _PackedColorArray = 
    8

    let _PackedVector4Array = 
    8
